...
def read_all_accounts():
    """
    Reads all accounts
    This endpoint will read all Account from data repository
    """
...
def read_accounts(account_id):
    """
    Reads an Account
    This endpoint will read an Account based the id
    """
...
def update_accounts(account_id):
    """
    Updates an Account
    This endpoint will update an Account based the id and data json
    """
